...
const AccountPlatforms = () => {
  ...
  // console.log("Available Accounts Data:", accData);
  const platforms = useMemo(() => {
    if (!accData?.data?.result) return [];

    const grouped = accData.data.result
          ...
          <>
            <div className="p-6 mt-10">
              ...
              {platforms
                .filter(
                  (platform) =>
                    !selectedPlatform || platform.name === selectedPlatform
                )
                .map((platform) => (
