...
import { FaWallet, FaShoppingCart, FaMoneyBillWave, FaInstagram, FaFacebook, FaTwitter } from "react-icons/fa";
    ...
    <div className="p-6 space-y-10 font-custom">
             <div className="flex items-center justify-between gap-4 mb-8">
                ...
                <div className=" px-4 py-2">
                  ...
                  <span className=" rounded-lg px-4 py-2 font-medium bg-gradient-to-r from-[#622BB9] to-[#351A60] cursor-pointer text-white">{user.balance}</span>
                </div>
              </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-4 mt-10">
        {/* Card 1 - Wallet Balance */}
            ...
            <div className="bg-white rounded-2xl shadow-md  flex flex-col w-full">
                ...
                <div className="p-4 rounded-full text-white mb-2">
                    <img src={WalletBalance} alt="Wallet Icon" className="w-10 h-10" />
                </div>
                <h4 className="text-[#515151] font-medium text-[16px] p-4">Wallet Balance</h4>
                </div>
        ...
        <div className="relative bg-white rounded-2xl shadow-md flex flex-col w-full overflow-hidden">
            ...
            <div className="flex flex-col mb-6">
                <div className="p-4 rounded-full text-white mb-2">
                <img src={TotalOrder} alt="Wallet Icon" className="w-10 h-10" />
                </div>
                <h4 className="text-[#515151] font-medium text-[16px] p-4">Total Orders</h4>
            </div>
        ...
        <div className="flex flex-col mb-6">
            <div className="p-4 rounded-full text-white mb-2">
            <img src={TotalDeposit} alt="Wallet Icon" className="w-10 h-10" />
            </div>
            <h4 className="text-[#515151] font-medium text-[16px] p-4">Total Deposits</h4>
        </div>
